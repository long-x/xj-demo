...
public class IaasApplyConfigInfoVO {
    /**
     * 主键
     */
    ...
    @ApiModelProperty("状态：1，待处理；2.处理中；3.已完成")
    ...
    @ApiModelProperty("是否自动发放")
    private String autoIssue;

    @ApiModelProperty("端口映射")
    private List<IaasApplyPortMappingAskVO> portMappingAskVOS;

    @ApiModelProperty("存储盘")
    private List<IaasApplyMemoryDiskVO> memoryDiskVOList;
