...
public class NetworkSegmentVO implements Serializable  {

    private static final long serialVersionUID = 1320599489185197377L;
    ...
    private List<NetworkIpVO> networkIpList;
}
