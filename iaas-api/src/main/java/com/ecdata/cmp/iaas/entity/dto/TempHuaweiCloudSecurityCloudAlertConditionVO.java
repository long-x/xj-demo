...
@ApiModel(value = "华为云及安全云告警情况临时表 拓展类对象", description = "华为云及安全云告警情况临时表 拓展类对象")
public class TempHuaweiCloudSecurityCloudAlertConditionVO implements Serializable {

    private static final long serialVersionUID = -3066767637484500194L;
    /**
     * 主键
     */
