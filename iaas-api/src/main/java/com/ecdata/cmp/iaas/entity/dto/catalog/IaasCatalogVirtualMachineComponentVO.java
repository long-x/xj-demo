...
public class IaasCatalogVirtualMachineComponentVO implements Serializable {
    ...
    private List<IaasCatalogVirtualMachineComponentParamVO> compParams;

    @ApiModelProperty("组件脚本")
    private List<IaasCatalogVirtualMachineComponentScriptVO> compScripts;

    @ApiModelProperty("组件操作")
    private List<IaasCatalogVirtualMachineComponentOperationVO> compOps;
