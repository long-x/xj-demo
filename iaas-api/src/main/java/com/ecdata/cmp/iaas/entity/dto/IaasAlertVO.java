...
public class IaasAlertVO extends Model<IaasAlertVO> {


	private static final long serialVersionUID = 3018704476757396487L;
	/**
	 * 主键
	 */
  ...
  @ApiModelProperty(value = "是否已删除(0表示未删除,1表示已删除)")
	...
	private List<IaasAlertVO> children;
