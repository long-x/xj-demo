 ...
 * @Author: shig
 * @description:
 * @Date: 2020/3/5 8:34 下午
 */
@Data
@ApiModel(value = "竹云组织机构 返回的账号", description = "竹云组织机构 返回的账号")
public class BimOrgOrganizationResp implements Serializable {
    private static final long serialVersionUID = -4152725750267581313L;
