...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private com.ecdata.cmp.activiti.webService.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           com.ecdata.cmp.activiti.webService.WorkflowRequestTableRecord[] requestRecords,
           String tableDBName) {
     ...
     */
    public com.ecdata.cmp.activiti.webService.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(com.ecdata.cmp.activiti.webService.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
