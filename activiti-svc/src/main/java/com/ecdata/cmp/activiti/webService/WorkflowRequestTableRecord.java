...
public class WorkflowRequestTableRecord  implements java.io.Serializable {
    ...
    private com.ecdata.cmp.activiti.webService.WorkflowRequestTableField[] workflowRequestTableFields;
    ...
    public WorkflowRequestTableRecord(
           Integer recordOrder,
           com.ecdata.cmp.activiti.webService.WorkflowRequestTableField[] workflowRequestTableFields) {
     ...
     */
    public com.ecdata.cmp.activiti.webService.WorkflowRequestTableField[] getWorkflowRequestTableFields() {
        return workflowRequestTableFields;
    }
     ...
     */
    public void setWorkflowRequestTableFields(com.ecdata.cmp.activiti.webService.WorkflowRequestTableField[] workflowRequestTableFields) {
        this.workflowRequestTableFields = workflowRequestTableFields;
    }
