...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "FreeCapacity", description = "FreeCapacity对象")
public class FreeCapacity implements Serializable {
    private static final long serialVersionUID = -8749549607666335765L;
    /**
     * 容量信息是否为空
     */
