...
@NoArgsConstructor
@Builder
@ApiModel(value = "深信服-脆弱性-明文传输信息-Item", description = "深信服-脆弱性-明文传输信息-Item")
public class PlainTextItemVO {
    ...
    /**
     * 脆弱性等级(好像只 在漏洞中看到了) 1：低风险 2：高风险 3：危险
     */
