...
@TableName("temp_global_resource")
@ApiModel(value = "整体资源临时表 对象", description = "整体资源临时表 对象")
public class TempGlobalResource extends Model<TempGlobalResource> {
    private static final long serialVersionUID = -6882733132344122182L;
    /**
     * 主键
     */
