...
@TableName("iaas_template_virtual_machine")
@ApiModel(value = "iaas模板虚机对象", description = "iaas模板虚机对象")
public class IaasTemplateVirtualMachine extends Model<IaasTemplateVirtualMachine> {
