...
@NoArgsConstructor
@AllArgsConstructor
@TableName("iaas_catalog_virtual_machine_component_operation")
@ApiModel(value = "iaas服务目录虚拟机组件操作表", description = "iaas服务目录虚拟机组件操作表")
public class IaasCatalogVirtualMachineComponentOperation extends Model<IaasCatalogVirtualMachineComponentOperation> {
    /**
     * 主键
     */
