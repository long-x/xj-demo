...
@NoArgsConstructor
@AllArgsConstructor
@TableName("iaas_catalog_virtual_machine_component_script")
@ApiModel(value = "iaas服务目录虚拟机组件脚本表", description = "iaas服务目录虚拟机组件脚本表")
public class IaasCatalogVirtualMachineComponentScript extends Model<IaasCatalogVirtualMachineComponentScript> {
    /**
     * 主键
     */
