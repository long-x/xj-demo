...
@NoArgsConstructor
@AllArgsConstructor
@TableName("iaas_process_apply_virtual_machine_network")
@ApiModel(value = "iaas流程申请虚机网络表", description = "iaas流程申请虚机网络表")
public class IaasProcessApplyVirtualMachineNetwork extends Model<IaasProcessApplyVirtualMachineNetwork> {
    /**
     * 主键
     */
