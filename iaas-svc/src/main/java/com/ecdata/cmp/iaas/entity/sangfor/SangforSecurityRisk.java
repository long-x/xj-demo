package com.ecdata.cmp.iaas.entity.sangfor;
...
@TableName("iaas_sangfor_security_risk")
@ApiModel(value = "深信服安全风险", description = "深信服安全风险")
public class SangforSecurityRisk extends Model<SangforSecurityRisk> {

    private static final long serialVersionUID = 4574131197144601469L;
