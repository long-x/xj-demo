...
@TableName("iaas_component_param")
@ApiModel(value = "组件参数", description = "组件参数")
public class IaasComponentParam extends Model<IaasComponentParam> {

    private static final long serialVersionUID = -2965984373136126093L;
