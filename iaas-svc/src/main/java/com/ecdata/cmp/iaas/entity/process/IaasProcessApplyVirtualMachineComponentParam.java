...
@NoArgsConstructor
@AllArgsConstructor
@TableName("iaas_process_apply_virtual_machine_component_param")
@ApiModel(value = "iaas流程申请虚机组件参数表", description = "iaas流程申请虚机组件参数表")
public class IaasProcessApplyVirtualMachineComponentParam extends Model<IaasProcessApplyVirtualMachineComponentParam> {
    /**
     * 主键
     */
