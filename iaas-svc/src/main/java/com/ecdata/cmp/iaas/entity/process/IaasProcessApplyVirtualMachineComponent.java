...
@NoArgsConstructor
@AllArgsConstructor
@TableName("iaas_process_apply_virtual_machine_component")
@ApiModel(value = "iaas流程申请虚机组件表", description = "iaas流程申请虚机组件表")
public class IaasProcessApplyVirtualMachineComponent extends Model<IaasProcessApplyVirtualMachineComponent> {
    /**
     * 主键
     */
