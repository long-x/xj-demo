...
/**
 * @author ZhaoYX
 * @since 2019/11/20 10:36,
 */
@Data
@ToString
@NoArgsConstructor
@Accessors(chain = true)
@TableName("res_workorder")
@ApiModel(value = "工单对象", description = "工单对象")
public class ResWorkorder extends Model<ResWorkorder> {
    private static final long serialVersionUID = -1175995264026531604L;
